...
import { HomeIcon, TruckIcon, PlusCircleIcon, BellIcon, UserCircleIcon, SunIcon, MoonIcon, ArrowRightOnRectangleIcon, CalendarIcon } from '@heroicons/react/24/outline';
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${isActive('/admin/manage-bookings') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 shadow-sm border border-indigo-100 dark:border-indigo-800' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-indigo-300'}`}
            >
